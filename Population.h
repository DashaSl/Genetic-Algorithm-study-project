...
class Population{
    public:
        ...
        Population(Polynomial &polynom, double down = 0, double up = 100, int countIndivids = 50, int countSteps = 10, double probMutation = 0.2, double probReproduction = 0.6); // генерируется популяция из count_individs особей 
